<div class="max-w-screen-xl p-5 mx-auto sm:p-10 md:p-16">
    <div class="flex justify-between mb-5 text-sm border-b">
        <div class="flex items-center pb-2 pr-2 text-indigo-600 uppercase border-b-2 border-indigo-600">
            @role('user')
            ...
            <a href="{{route('products.create')}}" class="inline-block font-semibold">Add product</a>
            @endrole
        </div>
